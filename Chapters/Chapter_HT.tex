...
Following the application of the threshold a gaussian filter with $ \sigma_{x,y,z} = 1 $ was applied in order to remove speckling found surrounding the end-caps.
