...
meshing errors that may occur (it is unlikey that masks would be created at
$\pm$ 1 voxel arround the whole model). To attempt to answer this a user
variability test was carried out in \cref{bov_chap}. %TODO finish this bit
