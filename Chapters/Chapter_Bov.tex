...
\cref{fig:barchartcompgrads} would give an equal value for the stiffness or
...
The average difference between the 0 - 5000 N section and the 0 - 9500 N
section was much smaller compared to the 0 - 1500 N section, hence 5000 N was
used as the limit on the already fractured vertebrae tests. Due to the slight
convergence towards 5000 N, this value was seen as a compromise between the
risk of further damage whilst still obtaining a genuine value for the
stiffness.
...
\paragraph{Radio-opacity of Cement} A second problem was the opacity of the
...
This work was carried out in parallel to that described in the experimental
...
Another preliminary study (preliminary given the limited nature of the
