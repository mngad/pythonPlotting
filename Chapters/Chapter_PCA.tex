...
However, despite the similarity in the mean of the greyscale variation for PC2 and PC3, the distribution %TODO
...
\begin{figure}[p]
  \centering
  \includegraphics[width=.9\textheight,angle=90]{Chapters/Chapter_PCA_images/all_pc3_slice.png}
	\caption[The variation in the greyscale distribution across the mid-slice of the vertebrae generated from PC3.]{The variation in the greyscale distribution across the mid-slice of the vertebrae generated from PC3.
Showing how the posterior becomes denser with growing vertebral body size.
