...
if __name__ == "__main__":
    ...
    dotsize = 50
    plt.scatter(x=x1,y=y1,color='red',s=dotsize, marker='o', label='Normal Method')
    plt.scatter(x=x2,y=y2,color='blue',s=dotsize, marker='^', label='BV/TV Method')
    ...
    plt.text(5500,2500,s='CCC=0.55', color='red')
    
    plt.text(3500,6200,s='CCC=0.86', color='blue')
    plt.tight_layout()
    #plt.show()
    plt.savefig('intact_norm_bvtv.eps', dpi=320, facecolor='w', edgecolor='w',
