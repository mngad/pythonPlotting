...
if __name__ == "__main__":
    ...
    df = pd.read_csv(
        'M:\Git_Repos\pythonPlotting\perc_change_disp_conc.scv',
        header=0,
        sep=',')
    #df2 = pd.read_csv(
    ...
    plt.ylabel('Percentage Change from Pre- to \n Post- Augmented Stiffness (%)', fontsize=32)
    plt.xlabel('Percentage Cement Fill (%)',fontsize=32)
