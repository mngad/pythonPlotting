...
#                 color='r',
#                 label='Spine 1 L3')
#rects4 = plt.bar(index , VB3, bar_width,
#                 alpha=opacity,
#                 color='c',
#                 label='Spine 1 L4')
rects5 = plt.bar(index + (bar_width *0), VB4, bar_width,
                 alpha=opacity,
                 color='m',
                 label='Spine 1 L5')
...
#                 label='Spine 4 L3')
#rects13 = plt.bar(index+ (bar_width *0), VB12, bar_width,
#                 alpha=opacity,
#                 color='xkcd:turquoise',
#                 label='Spine 4 L4')
rects14 = plt.bar(index + (bar_width *1), VB13, bar_width,
                 alpha=opacity,
                 color='xkcd:mustard',
                 label='Spine 4 L5')
...
plt.tight_layout()
#plt.show()
plt.savefig('hum_L5_1_2.png', dpi=None, facecolor='w', edgecolor='w',
