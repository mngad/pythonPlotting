...
#                 color='b',
#                 label='Spine 1 L1')
rects2 = plt.bar(index  , VB1, bar_width,
                 alpha=opacity,
                 color='g',
                 label='Spine 1 L2')
...
#                 color='k',
#                 label='Spine 3 L1')
rects8 = plt.bar(index+ (bar_width), VB7, bar_width,
                 alpha=opacity,
                 color='xkcd:purple',
                 label='Spine 3 L2')
...
#                 color='xkcd:olive',
#                 label='Spine 4 L1')
rects11 = plt.bar(index+ (bar_width*2), VB10, bar_width,
                 alpha=opacity,
                 color='xkcd:salmon',
                 label='Spine 4 L2')
...
plt.tight_layout()
#plt.show()
plt.savefig('hum_L2_1_2.png', dpi=None, facecolor='w', edgecolor='w',
